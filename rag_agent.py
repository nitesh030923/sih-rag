...
LLM_MODEL = os.getenv('LLM_CHOICE', 'llama3.1' if LLM_PROVIDER == 'ollama' else 'gpt-4o-mini')
...
if LLM_PROVIDER == 'ollama':
    ...
    # Create custom OpenAI provider for Ollama
    ...
    agent = Agent(
        OpenAIModel(LLM_MODEL, provider=ollama_provider),
